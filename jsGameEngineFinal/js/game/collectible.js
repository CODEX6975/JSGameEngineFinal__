...
class Collectible extends GameObject {
  ...
  // Override the update method to include pause handling
  update(deltaTime) {
    // If the game is paused, do not update the collectible
    if (this.game.state === "paused") return;

    // Call the update method of the parent class (GameObject), which will update all of the collectible's components.
